...
//               <EnvelopeSimple className="h-6 w-6 mr-2" />
//             <span className="text-2xl font-mono tracking-tight">Mailzard</span>
//           </div>
          
//           {/* Decorative elements */}
//           <div className="absolute left-10 top-20 transform -rotate-12">
//             <PaperPlaneTilt className="h-12 w-12 text-gray-300" />
//           </div>
//           <div className="absolute right-20 top-10">
//             <EnvelopeSimple className="h-10 w-10 text-gray-300" />
//           </div>
...
//             <div className="text-gray-300 transform rotate-12 text-sm font-mono">{'<EnvelopeSimple/>'}</div>
//           </div>
//         </div>
